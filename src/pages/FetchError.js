...
<div className="h-screen w-screen bg-gray-50 flex items-center">
    <div className="container flex flex-col md:flex-row items-center justify-between px-5 text-gray-700">
            ...
            <p className="text-2xl md:text-3xl font-light leading-normal mb-8">
                Oops, Sorry about this. Please Keep trying, the API misbehaves at times. &#128517; 
            </p>
            ...
            <div onClick={reload} className="px-5 inline py-3 text-sm font-medium leading-5 shadow-2xl text-white transition-all duration-400 border border-transparent rounded-lg focus:outline-none bg-green-600 active:bg-red-600 cursor-pointer hover:bg-red-700">back</div>
    </div>
